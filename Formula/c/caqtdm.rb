class Caqtdm < Formula
  ...
  def install
    require "macho"
    perl_hostarch = Formula["epicsbase"].opt_bin
    perl_hostarch /= "EpicsHostArch.pl"
    hostarch = Utils.safe_popen_read(perl_hostarch).strip
  ...
  test do
    ...
    assert_path_exists prefix/"caQtDM.app/Contents/MacOS/caQtDM"
  end
end
